...
public class NettyClient {
     ...
     * @throws Exception
     */
    public void connect(boolean isNCB, final String host, final int port, final NettyClientIntHandler he)
            throws Exception {
     ...
     * @param he
     */
    public void connect(final String host, final int port, final NettyClientIntHandler he)
            throws Exception {
        workerGroup = new NioEventLoopGroup();
        try {
            Bootstrap b = new Bootstrap();
